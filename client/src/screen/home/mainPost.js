      ...
      <Card className='mt-3 p-3'>
        <div>
          <div className='d-flex'>
            ...
            <input placeholder="What's on your mind, Yakut?" className='py-2 ps-3 pe-5 w-100' style={{ borderRadius: "25px", border: "1px solid", background: "#ededed", borderColor: "#ededed" }} />
          </div><hr></hr>
          <div className='d-flex w-100 justify-content-between post-button-con'>
            <button className='w-100 py-2'><VideoCallIcon className='text-danger' /> Live video</button>
            <button className='w-100 py-2  mx-2' ><InsertPhotoIcon className='text-success' /> Photo/video</button>
            <button className='w-100 py-2 ' ><EmojiEmotionsIcon className='text-warning' /> Feeling/activiy</button>
          </div>
        </div>
        <div></div>
      </Card>
