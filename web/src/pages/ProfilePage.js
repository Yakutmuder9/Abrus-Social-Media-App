...
const ProfilePage = () => {
  ...
  const { post, posts, isError, isSuccess, message } = useSelector(
    (state) => state.post
  );
    ...
    <div className="profile-page  bg-light">
      {!profile ? (
        ...
        <>
          <div className="">
            <img
              src="https://media.istockphoto.com/vectors/abstract-cube-round-display-for-product-on-website-in-modern-with-vector-id1288200291?k=20&m=1288200291&s=612x612&w=0&h=pu0lo7-Rv41tIAdVMrYYi-B-bMm2Ss_hRWCmjp2Kp00="
              alt="profile-picture"
            ...
            <div className="profile-text-container">
              <div
                ...
                style={{ right: "20px", top: "5%", pointer: "none" }}
              >
              ...
              <div className="">
                ...
                <div className="">
                  ...
                  <div className="d-flex justify-content-center pb-3 friends-img-list ps-4">
                    <img
                      src="https://www.socialmirror.in/upload/media/posts/2021-09/19/professional-profile-pictures_1632045875-b.jpg"
                      alt=""
                    ...
                    <img
                      ...
                      alt=""
                      className="rounded-circle friend-img-pos"
                    />
                    <img
                      src="https://www.tap2assist.me/content/images/Profile/man04-600-thumb.jpg"
                      alt=""
                      className="rounded-circle friend-img-pos"
                    />
                    <img
                      src="https://static-cse.canva.com/blob/951359/1600w-YTfEMXMuMCs.jpg"
                      alt=""
                      className="rounded-circle friend-img-pos"
                    />
                    <img
                      src="https://d2kf8ptlxcina8.cloudfront.net/YH5TFCE1QY-preview.png"
                      alt=""
                      className="rounded-circle friend-img-pos"
                    />
                  </div>
                      ...
                      posts.map((item, key) => {
                        return (
                          <Card className="mt-2 py-2 mx-0" key={item._id}>
                            ...
                            <p
                              className={
                                item.description == "null" ? "d-none" : "px-4"
                              }
                            >
                              {item.description}
                            </p>
                            <CardMedia
                              ...
                              className={
                                item.image === "null" ? "d-none" : "d-block"
                              }
                            ...
                            <div>
                              <div className="d-flex mt-2 justify-content-between px-2">
                                <div className="d-flex">
                                  ...
                                  <p className="ps-1">
                                    Nova, Kean and other 3170 other
                                  </p>
                                </div>
                              ...
                              <div className="d-flex w-100 justify-content-between post-button-con px-2">
                                ...
                                <button className="w-100 py-2  mx-2">
                      ...
                      <div className="card mb-3">
                        <div className="row g-0">
                          <div className="col-md-4">
                            <img
                              src="https://i.pinimg.com/originals/57/f6/58/57f658978f5fed9e81655a2394ef8f32.jpg"
                    ...
                    <Card className="mt-2 py-2">
                      <div className="card mb-3">
                        <div className="row g-0">
                          <div className="col-md-4">
                            <img
                              src="https://i.pinimg.com/736x/18/02/64/18026433d81cf0bb68819bf28a358885.jpg"
                              className="img-fluid rounded-start"
                              alt="..."
