  ...
  return (
    <div className="top-nav-bar  d-flex justify-content-between align-items-center px-4 py-2 sticky-top">
      ...
      <div className="logo-name ps-2">
        <h2 className="text-primary d-none d-md-block">Abrus</h2>
      </div>
      <div className="nav-search">
        <input
          placeholder="Search Merabook"
          className="py-1 px-3  d-none d-md-block"
        />
      </div>
      <div className="d-flex justify-content-between align-items-center w-100 d-flex d-md-none mobile-size-nav">
        ...
        <span>
          <NavLink to="/watch" className="menu-link ">
            <FaVideo />
          </NavLink>
        </span>
        <span>
          <NavLink to="/marketplace" className="menu-link ">
            <AiTwotoneShop />
          </NavLink>
        </span>
        <span>
        ...
        <span className="mobile_ava">
          ...
          >
            <Avatar
              ...
              className="text-dark moblie-avator"
            />
          </NavLink>
        </span>
      </div>
      <div className="d-none d-md-flex">
        ...
        <a href={"/profile/" + profile?.firstName + "." + profile?.lastName}>
          <Avatar src={profile?.profile_pic} className="text-dark" />
        </a>
      </div>
    </div>
  );
